...
<div class="max-w-xl mx-auto p-6">
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <input name="slug" class="border rounded p-2 w-full" value="{{ old('slug') }}" placeholder="auto-generated if blank">
        </div>

        <div class="flex gap-2">
            <button class="bg-black text-white rounded px-4 py-2">Create</button>
